...
> Status: **contract still the v0.5 source of truth.** Implementation and RC fixes landed on `feat/v0.5-market-intelligence` @ `95398c4`. Protocol v1 is additive. Default tests do not call a model.
>
